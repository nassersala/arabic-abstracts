...
**Glossary Terms Used:** reliability (موثوقية), scalability (قابلية التوسع), availability (التوافر), storage (تخزين), consistency (اتساق), architecture (معمارية), infrastructure (بنية تحتية), key-value store (مخزن مفتاح-قيمة), versioning (إصدارات), conflict resolution (حل التعارضات)
...
- **Key terms:**
  ...
  - "Massive scale" → "نطاق ضخم"
  - "E-commerce" → "التجارة الإلكترونية"
  - "Infrastructure" → "بنية تحتية"
  - "Datacenters" → "مراكز البيانات"
  - "Persistent state" → "الحالة الثابتة"
  - "Scalability" → "قابلية التوسع"
  - "Highly available" → "عالي التوافر"
  - "Key-value storage system" → "نظام تخزين مفتاح-قيمة"
  - "Always-on" → "دائمة التشغيل"
  - "Consistency" → "الاتساق"
