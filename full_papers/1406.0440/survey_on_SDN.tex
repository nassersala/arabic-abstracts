...
debugging and troubleshooting.  In an effort to anticipate the future
...
\input{text/0_introduction.tex}
\input{text/1_traditional_nets.tex}
\input{text/2_what_is_sdn.tex}
\input{text/3_history_of_sdn.tex}
\input{text/4_sdn_in_layers.tex}
\input{text/5_challenges.tex}
%\input{text/6_domains.tex}
%\input{text/7_open_roads.tex}
%\input{text/7_killer_apps.tex}
\input{text/8_conclusion.tex}
