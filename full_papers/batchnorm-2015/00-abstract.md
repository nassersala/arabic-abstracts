...
- **Key terms introduced:** internal covariate shift (التحول التباين الداخلي), batch normalization (تطبيع الحزمة), saturating nonlinearities (اللاخطيات المشبعة)
- **Equations:** None in abstract
- **Citations:** None in abstract
- **Special handling:** Technical terms maintained consistency with glossary
...
**Note:** This abstract was previously translated in translations/1502.03167.md with a quality score of 0.90.
